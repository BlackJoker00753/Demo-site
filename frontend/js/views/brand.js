      ...
      <article class="brand">
        ...
        <section class="catalog" id="catalog">
          ...
          <div class="container">
            ...
            <p class="catalog__note muted">Цены: официальная розница в США на дату проверки, если не указано иное. Нажмите на модель, чтобы открыть её историю, механизм и разборку. Все фото настоящие, их авторы и лицензии на странице <a href="/credits">«Авторы фотографий»</a>.</p>
          </div>
        </section>
