...
**Интерактивный атлас часового искусства.** Не магазин, а энциклопедия: глобус со странами, мануфактуры, модели, механизмы, усложнения и актуальные цены. Везде только настоящие фотографии (с авторами и лицензиями), а в конце страницы модели настоящий механизм разбирается по скроллу на детали, снятые на фото.
